...
var cst_ttl2_w=0; //ttl2标题2 宽

var cst_line_w=1; //圆点宽

var cst_round_w=1.5; //圆点

var padd=0; //圆点padding
		...
		37: [function(t, e, n) {
			...
			e.exports = function(t) {
				...
				var i = t.helpers,
					...
					r = a.defaultColor;
				a.elements.point = {
					radius:cst_round_w , //圆点
					pointStyle: "circle",
					backgroundColor: r,
					borderWidth: 3,
					borderColor: r,
					hitRadius: 3,
					hoverRadius: cst_round_w,//hover圆点
					hoverBorderWidth: cst_round_w

var xhr;
    ...
    function UpladFile()
    {
        ...
        var FileController = 'upload_1.php';
    ...
    function UpladFile2()
    {
        ...
        var FileController = 'upload_2.php';
        var form = new FormData();
    ...
    function UpladFile3()
    {
        ...
        var FileController = 'upload_3.php';
        var form = new FormData();
    ...
    function UpladFile4()
    {
        ...
        var FileController = 'upload_4.php';
        var form = new FormData();
    ...
    function UpladFile5()
    {
        ...
        var FileController = 'upload_5.php';
        var form = new FormData();
...
xmlhttp.open("get","del.php?pic="+bb,true);
//设置post请求头

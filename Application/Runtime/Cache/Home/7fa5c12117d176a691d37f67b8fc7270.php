...
<link rel="stylesheet" type="text/css" href="/sjshop/Public/New_style/skin/sjzx/css/cst-style.css" />
<style type="text/css">
  .market-map-ttl {
    padding: 10px;
    background: #ddd;
   ...
   <div class="seach_content">   
     ...
     <div class="market-map-ttl">
      ...
      <div class="chuanhuo_top" id="chuanhuo_top">
        <div class="chuanhuo_title"><span>船柜货</span>报价
...
$(document).ready(function(){ 
    ...
    //品名
    //向服务器发送请求(get、post) 
    $.get("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_cInvName",'123',function(data){ 
    ...
    $.get("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_cInvName_more",'123',function(data){ 
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdata/ajax_list_vendor",{cInvName:'POM'},function(data){ 
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdata/ajax_list_vendor_more",{cInvName:'POM'},function(data){ 
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdata/ajax_list_cInvStd",{cInvName:'POM',vendor:'日本宝理'},function(data){ 
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdata/ajax_list_cInvStd_more",{cInvName:'POM',vendor:'日本宝理'},function(data){ 
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdata/ajax_list_address",{cInvName:'POM',vendor:'日本宝理',cinvstd:'M90-44'},function(data){ 
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdata/ajax_list_address_more",{cInvName:'POM',vendor:'日本宝理',cinvstd:'M90-44'},function(data){ 
    ...
    $.get("http://localhost/weixin/index.php?s=/Home/Ajaxdata/ajax_test",'123',function(data){ 
...
function goSort(name,value){	
    ...
    $("#list_vendor").html('<div class="list_sty">加载中</div>'); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_vendor",{cInvName:value},function(data){ 
      $("#list_vendor").html(data); 
    }).error(function(){ 
      $("#list_vendor").html('<div class="list_sty">数据异常</div>') 
    })
	...
	$("#list_vendor_more").html('<div class="list_sty">加载中</div>'); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_vendor_more",{cInvName:value},function(data){ 
      $("#list_vendor_more").html(data); 
    }).error(function(){ 
      $("#list_vendor_more").html('<div class="list_sty">数据异常</div>') 
    })
	...
	$.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_vendor_one",{cInvName:value},function(data){ 
...
function goSort1(name,value){
	...
	$("#select-D").html('');
	$("#list_cInvStd").html('<div class="list_sty">加载中</div>'); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_cInvStd",{cInvName:name,vendor:value},function(data){ 
      $("#list_cInvStd").html(data); 
    }).error(function(){ 
      $("#list_cInvStd").html('<div class="list_sty">数据异常</div>') 
    })
	...
	$("#list_cInvStd_more").html('<div class="list_sty">加载中</div>'); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_cInvStd_more",{cInvName:name,vendor:value},function(data){ 
      $("#list_cInvStd_more").html(data); 
    }).error(function(){ 
      $("#list_cInvStd_more").html('<div class="list_sty">数据异常</div>') 
    })
	...
	$.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_cInvStd_one",{cInvName:name,vendor:value},function(data){ 
...
function goSort2(value1,value2,value3){
	...
	$("#select-D").html('');
	$("#list_address").html('<div class="list_sty">加载中</div>'); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_address",{cInvName:value1,vendor:value2,cinvstd:value3},function(data){ 
      $("#list_address").html(data); 
    }).error(function(){ 
      $("#list_address").html('<div class="list_sty">数据异常</div>') 
    })
	...
	$("#list_address_more").html('<div class="list_sty">加载中</div>'); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_address_more",{cInvName:value1,vendor:value2,cinvstd:value3},function(data){ 
      $("#list_address_more").html(data); 
    }).error(function(){ 
      $("#list_address_more").html('<div class="list_sty">数据异常</div>') 
    })
	...
	saerch_baojia_count(data1,data2,data3,data4);
	 ...
	 $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_list_address_one",{cInvName:value1,vendor:value2,cinvstd:value3},function(data){ 
...
function goSort3(value1,value2,value3,value4){
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_xinghao_baojia",{cInvName:value1,vendor:value2,cinvstd:value3},function(data){ 
...
function saerch_baojia(value1,value2,value3,value4){
	$("#list_baojia_xinghao").text(''); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_saerch_baojia",{cInvName:value1,vendor:value2,cinvstd:value3,address:value4},function(data){ 
	   //alert(data);
      ...
      //$(".table tbody").append(data); 
	   ...
	   //alert(data);
				$.each(data, function(idx, obj) {
						     //alert(obj.id);
							 dataurl = "/sjshop/index.php/Home/Baojialist/baojialist_cgh_mx?cInvName="+obj.cinvname+"&vendor="+obj.vendor+"&cInvStd="+obj.cinvstd+"&address="+obj.address
							 +"&paixu=truetime desc";
...
function saerch_baojia_count(value1,value2,value3,value4){
    ...
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_saerch_baojia_count",{cInvName:value1,vendor:value2,cinvstd:value3,address:value4},function(data){ 
      //$(".table tbody").append(data); 
...
function saerch_baojia_city(value){
	...
	$("#list_baojia_xinghao").text(''); 
    $.post("/weixin/index.php?s=/Home/Ajaxdatacgh/ajax_saerch_baojia_city",{city:value},function(data){ 
	   //alert(data);
	    data = JSON.parse(data);
      //$(".table tbody").append(data); 
	   //data = JSON.stringify(data);

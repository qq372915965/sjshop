  ...
  <div class="supply_content">
    <div class="supply_content_list">
      <div class="supply_content_position">
        当前位置：<a href="/">首页</a>&nbsp;>&nbsp;<a href="/e/action/ListInfo/list_bj.php?paixu=id">市场报价</a>&nbsp;>&nbsp;<span class="supply_cp"><?php echo $cInvName; ?>&nbsp;<?php echo $vendor; ?>&nbsp;<?php echo $cInvStd; ?>&nbsp;<?php echo $address; ?>&nbsp;香港现货报价</span>
      </div>
    ...
    if($this[0].href==String(window.location)){
      ...
      <div class="supply_allinfo">
         <div class="supply_allinfo_one">
            <a href="gongying_xgfp.php?cInvName=<?php echo $cInvName;?>&vendor=<?php echo $vendor;?>&cInvStd=<?php echo $cInvStd;?>(2)&address=<?php echo $address;?>&paixu=truetime desc" target="_blank">查看副牌报价</a>
          </div>
        <!-- <div class="supply_allinfo_one">
...
<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr class='even' style='position: relative !important;'>
     <!--  <td><a href='/e/action/Showxgxh.php?id=<?=$value['id']?>' onclick='visitor_click(this)' class='visitor'><?php echo $value['cInvName']?></a></td>
     ...
     <td><?php echo $value['vendor']?></td> -->
      ...
      <td><?php echo $value['valid_day']?></td>

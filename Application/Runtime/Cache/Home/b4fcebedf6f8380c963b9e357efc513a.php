...
<!--显示电话号码-->
<link rel="stylesheet" type="text/css" href="/skin/sjzx/css/phone/showphone.css"/>
<!--显示电话号码icon-->
<link rel="stylesheet" type="text/css" href="/skin/sjzx/css/phone/iconfont.css"/>
  ...
  <div class="supply_content">
    <div class="supply_content_list">
      <div class="supply_content_position">
        当前位置：<a href="/">首页</a>&nbsp;>&nbsp;<a href="/e/action/ListInfo/list_bj.php?paixu=id">市场报价</a>&nbsp;>&nbsp;<span class="supply_cp"><?php echo $cInvName; ?>&nbsp;<?php echo $vendor; ?>&nbsp;<?php echo $cInvStd; ?>&nbsp;<?php echo $address; ?>&nbsp;香港期货报价</span>
      </div>
      ...
      <div class="supply_allinfo">
        ...
        <table class="supply_table" id="tbPerson">
          ...
          <tr class="odd">
            ...
            <th width="107">牌号</th>
            <th width="148">厂商</th> -->
            <th width="136"><span style="text-indent: 0px;width:105px;">价格(美元/公吨)</span>
                       <div class="a_img">
                       <button onclick="JavaScript:sortTable('tbPerson',3,'float',0)" class="a_1" title="价格从低到高排列"></button>
                       <button onclick="JavaScript:sortTable('tbPerson',3,'float',1)" class="a_2" title="价格从高到低排列"></button>
                       </div></th>
            <th width="106"><span style="width:75px;">数量(公吨)</span>
                       <div class="a_img">
                       <button onclick="JavaScript:sortTable('tbPerson',4,'float',0)" class="a_1" title="数量从低到高排列"></button>
                       <button onclick="JavaScript:sortTable('tbPerson',4,'float',1)" class="a_2" title="数量从高到低排列"></button>
                       </div></th>
            <th width="108">票据</th>           
            <th width="95">免仓期</th>
            <th width="115">交货地点</th>
            <th width="90">最迟到港日期</th>
            <th width="120">供应商</th>
...
<?php if(is_array($data)): foreach($data as $key=>$value): ?><tr class='even' style='position: relative !important;'>
      <!-- <td><a href='/e/action/Showxgqh.php?id=<?=$value['id']?>' onclick='visitor_click(this)' class='visitor'><?php echo $value['cInvName']?></a></td>
      ...
      <td><?php if($value['mian']=="1"){echo "7天";}else if($value['mian']=="2"){echo "14天";}else if($value['mian']=="3"){echo "21天";}?></td>
      <td><?php echo $value['address']?></td>
      <td><?php echo $value['dvaliddate']?></td>
      <td style='position: relative !important;'>
          <span class='carte' id='ct_u4'><a data-rel='<?php echo $value['id']?>' style='display:block; z-index:0;overflow: hidden;text-overflow: ellipsis;white-space: nowrap; height: 40px;line-height: 40px;'><?php echo $value['companyreferred']?></a>
              <div class='supplier_tan'  id='thelayer<?php echo $value['id']?>' style='display: none;position:absolute;'>
...
<script type="text/javascript" charset="utf-8" src="/sjshop/Public/New_style/skin/sjzx/js/phone/showhpone.js" ></script>
<script type="text/javascript" charset="utf-8" src="/sjshop/Public/New_style/skin/sjzx/js/fuchuang.js"></script>
<script type="text/javascript" charset="utf-8" src="/sjshop/Public/New_style/skin/sjzx/js/search.js"></script>
<script type="text/javascript">

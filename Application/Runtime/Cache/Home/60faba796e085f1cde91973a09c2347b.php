...
<div class="lpart_position">
     ...
     <div class="market-map-ttl">
 			<label for="" >报价区域：</label>
			
			<a class="" href="javascript:saerch_baojia_city('东莞');" style="padding:0px;">东莞</a>
      <a class="" href="javascript:saerch_baojia_city('樟木头');" style="margin-left:0px;padding:0px;">(樟木头</a>
			<a class="" href="javascript:saerch_baojia_city('黄江');">黄江</a>
			<a class="" href="javascript:saerch_baojia_city('常平');">常平</a>
      <a class="" href="javascript:saerch_baojia_city('东莞其他');">其他)</a>
			<a class="" href="javascript:saerch_baojia_city('浙江');" style="padding:0px;">浙江</a>
      <a class="" href="javascript:saerch_baojia_city('余姚');" style="margin-left:0px;padding:0px;">(余姚</a>
      <a class="" href="javascript:saerch_baojia_city('浙江其他');">其他)</a>
			<a class="" href="javascript:saerch_baojia_city('江苏');" style="padding:0px;">江苏</a>
      <a class="" href="javascript:saerch_baojia_city('太仓');" style="margin-left:0px;padding:0px;">(太仓</a>
      <a class="" href="javascript:saerch_baojia_city('昆山');">昆山</a>
			<a class="" href="javascript:saerch_baojia_city('江苏其他');">其他)</a>
			<!-- <a class="" href="javascript:saerch_baojia_city('东莞');">东莞</a> -->
			<a class="" href="javascript:saerch_baojia_city('深圳');">深圳</a>
			<a class="" href="javascript:saerch_baojia_city('广州');">广州</a>
			<a class="" href="javascript:saerch_baojia_city('佛山');">佛山</a>
			<a class="" href="javascript:saerch_baojia_city('汕头');">汕头</a>		
      <a class="" href="javascript:saerch_baojia_city('上海');">上海</a>
      <a class="" href="javascript:saerch_baojia_city('山东');" style="padding:0px;">山东</a>
      <a class="" href="javascript:saerch_baojia_city('临沂');" style="margin-left:0px;padding:0px;">(临沂</a>
      <a class="" href="javascript:saerch_baojia_city('山东其他');">其他)</a>								              
    </div>

	  
      <div class="chuanhuo_top" id="chuanhuo_top">
        <div class="chuanhuo_title"><span>市场</span>报价
            ...
            <div class="seach-table" id="tbPerson">
              ...
              <table class="table">
                <thead>
                    ...
                    <th width="110" style="padding:8px 0px;">最新价格(元/吨)
...
function saerch_baojia(value1,value2,value3,value4){
    ...
    $.post("/sjshop/index.php?s=/Home/Ajaxdata/ajax_saerch_baojia",{cInvName:value1,vendor:value2,cinvstd:value3,address:value4},function(data){ 
	   //alert(data);
      ...
      //$(".table tbody").append(data); 
	   ...
	   //alert(data);
				$.each(data, function(idx, obj) {
						     //alert(obj.id);
							 dataurl = "/sjshop/index.php/Home/Baojialist/baojialist_dlxh_mx?cInvName="+obj.cinvname+"&vendor="+obj.vendor+"&cInvStd="+obj.cinvstd+"&address="+obj.address
							 +"&paixu=truetime desc";
...
function saerch_baojia_count(value1,value2,value3,value4){
    ...
    $.post("/sjshop/index.php?s=/Home/Ajaxdata/ajax_saerch_baojia_count",{cInvName:value1,vendor:value2,cinvstd:value3,address:value4},function(data){ 
      //$(".table tbody").append(data); 
...
function saerch_baojia_city(value){
	...
	$("#list_baojia_xinghao").text(''); 
    $.post("/sjshop/index.php?s=/Home/Ajaxdata/ajax_saerch_baojia_city",{city:value},function(data){ 
	   //alert(data);
	    data = JSON.parse(data);
      //$(".table tbody").append(data); 
	   //data = JSON.stringify(data);
		...
		<script type="text/html" id="must">
				...
				{{#must}}
                    ...
                    <div class="business_logo">
                        <p>
                            <img src="/sjshop/Public/New_style/skin/sjzx/img/yuan.png" width="100" height="100">
                            
                        </p>
                        <p>
                            <img src="/sjshop/Public/New_style/skin/sjzx/img/xing.png" width="14" height="14">
                            <img src="/sjshop/Public/New_style/skin/sjzx/img/xing.png" width="14" height="14">
                            <img src="/sjshop/Public/New_style/skin/sjzx/img/xing.png" width="14" height="14">
                            <img src="/sjshop/Public/New_style/skin/sjzx/img/xing.png" width="14" height="14">
                            <img src="/sjshop/Public/New_style/skin/sjzx/img/xing.png" width="14" height="14">
